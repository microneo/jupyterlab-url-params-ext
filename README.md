...
```bash
pip install jupyterlab_url_params_ext
```
...
```bash
pip uninstall jupyterlab_url_params_ext
```
...
# Change directory to the jupyterlab_url_params_ext directory
...
folder is located. Then you can remove the symlink named `jupyterlab_url_params_ext` within that folder.
